...
//FIRST, LAST AND TOTAL OCCURENCES.
public class Occurences {
    ...
    public static int totalOccurence(int[] a, int key){
        return lastOccurence(a, key)-firstOccurence(a, key)+1;
