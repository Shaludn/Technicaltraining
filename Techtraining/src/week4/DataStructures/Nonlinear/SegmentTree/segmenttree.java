package week4.DataStructures.Nonlinear.SegmentTree;

import java.util.Scanner;

public class segmenttree {
    private static final int MAX_SIZE=10005;
    private static int[] a=new int[MAX_SIZE];//input tree
    private static int[] seg=new int[4*MAX_SIZE];
    //fnction to build segment tree
    ...
    public static void main(String[] args){
        ...
        while(q--> 0){
            ...
            System.out.println(
                  "Maximum in range [" + l+ ", "+ r + "] is : "+result);
        }
    }
}
